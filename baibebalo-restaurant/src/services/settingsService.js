...
export const getPublicSettings = async () => {
  try {
    ...
    // La route /public/settings est publique et ne nécessite pas d'authentification
    const baseURL = API_BASE_URL.replace('/api/v1', '') || 'https://baibebaloprojets.onrender.com';
    const response = await axios.get(`${baseURL}/api/v1/public/settings`, {
