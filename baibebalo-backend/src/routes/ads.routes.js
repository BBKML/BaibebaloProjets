...
const { authenticate, authorize, requireActiveRestaurant } = require('../middlewares/auth');

const authenticateRestaurant = [authenticate, authorize('restaurant'), requireActiveRestaurant];
